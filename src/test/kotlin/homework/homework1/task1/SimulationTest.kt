...
internal class SimulationTest {
    ...
    */
    @Test
    fun run_5ComputersVer3_try1_mustWork() {
    ...
    @Test
    fun run_5ComputersVer3_try2_mustWork() {
        // Число 0.3 подобрано таким образом, чтобы устройства 2, 3 и 4 обязательно заразилось, а устройство 5 -- нет
